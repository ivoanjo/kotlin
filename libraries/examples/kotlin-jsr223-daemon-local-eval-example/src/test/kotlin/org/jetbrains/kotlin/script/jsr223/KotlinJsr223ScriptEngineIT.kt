...
class KotlinJsr223DaemonCompileScriptEngineIT {
    ...
    fun testEngineFactory() {
        ...
        factory!!.apply {
            ...
            Assert.assertEquals(KotlinCompilerVersion.getVersion(), languageVersion)
            Assert.assertEquals("kotlin", engineName)
            Assert.assertEquals(KotlinCompilerVersion.getVersion(), engineVersion)
            ...
            Assert.assertEquals(KotlinCompilerVersion.getVersion(), getParameter(ScriptEngine.LANGUAGE_VERSION))
